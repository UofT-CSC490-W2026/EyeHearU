"""
RL (GRPO on GSM8K) that uses GPTSwiGLU instead of the baseline GPT.

Monkey-patches GPT -> GPTSwiGLU, then runs the standard chat_rl main.
Same pattern as chat_cli_swiglu.py.

Run e.g.:
  torchrun --standalone --nproc_per_node=4 -m scripts.chat_rl_swiglu -- --model-tag=d12_swiglu
"""
